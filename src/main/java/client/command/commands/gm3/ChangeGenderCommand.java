...
public class ChangeGenderCommand extends Command {
    {
        setDescription("Changes Gender.");
    }
    ...
    public void execute(Client c, String[] params) {
        ...
        if (params.length > 1) {
            player.yellowMessage("Syntax: !changegender [<playername>]");
            return;
        }
